                                          ...
                                          <td class="wrapper">
                                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                                      <tr>
                                                            ...
                                                            <p>Here is a unique link for your cooperative: </p>
                                                            <p> <strong >{{ $data['url'] }} </strong> </p>
                                                            <p>Share the above link with your members only, so they can onboard on the platform under your cooperative</p>
