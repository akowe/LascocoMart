                                                ...
                                                <div
                                                      ...
                                                      <div class="card">
                                                            ...
                                                            @foreach(auth()->user()->unreadNotifications->where('type', 'App\Notifications\NewOrder') as $notification)
                                                                              ...
                                                                              <div class="col-auto">
                                                                        @if(auth()->user()->unreadNotifications->where('type', 'App\Notifications\NewOrder'))
                                                                  ...
                                                                  <div class="list-group-item">
                                                                        ...
                                                                        @foreach(auth()->user()->unreadNotifications->where('type', 'App\Notifications\ApproveFund') as $notification)
                                                                              ...
                                                                              <div class="col-auto">
                                                                               @if(auth()->user()->unreadNotifications->where('type', 'App\Notifications\ApproveFund'))
                                                ...
                                                <div class="list-group list-group-flush list-group-hoverable">
                                                      ...
                                                      <div class="list-group-item">
                                                            <div class="row align-items-center">
                                                                  ...
                                                                  <div class="col-auto">
                                                                        @if(auth()->user()->unreadNotifications->where('type', 'App\Notifications\ProductApproved'))
                                                                        <a href="" title="Clear" alt="Clear"
                                                                              class="small"><svg
                                                                                    xmlns="http://www.w3.org/2000/svg"
                                                                                    class="icon icon-tabler icon-tabler-x"
