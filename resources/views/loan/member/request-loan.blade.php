                        ...
                        <div class="card">
                              ...
                              <div class="card-body">
                                    ...
                                    <form action="{{ route('add-loan') }}" method="post">
                                          ...
                                          <input type="hidden" name="ratetype" value="{{$loanTypeID}}">
                                          <input type="hidden" name="duration" value="{{$duration}}">

                                          <input type="hidden" name="monthly_principal" value="{{$monthlyPrincipal}}">
                                          <input type="hidden" name="monthly_interest" value="{{$monthlyInterest}}">
                                          <input type="hidden" name="monthly_due" value="{{$totalMonthlyDue}}">
