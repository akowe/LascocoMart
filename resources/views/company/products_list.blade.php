      ...
      <div class="container-xl">
            <div class="row g-2 align-items-center">
                  <div class="col">
                        ...
                        <h2 class="page-title">
                              <span class=" d-none  d-md-block">Vendors Products</span>
                        ...
                        <div class="alert alert-important  alert-azure alert-dismissible" role="alert">
                              <div class="d-flex">
                                    ...
                                    <div>
                                          ...
                                          LascocoMart landing page. <span class="text-dark">"Remove" product; if you want to stop products from
                                          being visible on LascocoMart landing
                                          page.</span>
                                                      ...
                                                      <td>
                                                            <span class="dropdown">
                                                                  ...
                                                                  <div class="dropdown-menu">
                                                                        ...
                                                                        <p>
                                                                        <form action="{{ route('company-remove-product')}}"
