      ...
      <div class="container-xl">
            <div class="row g-2 align-items-center">
                  <div class="col">
                        ...
                        <h2 class="page-title">
                              <span class=" d-none  d-md-block">FMCG  (s)</span>
                                    ...
                                    <div class="card ">
                                          <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                      <div class="subheader">Total FMCG (s)</div>
                                    ...
                                    <div class="d-flex">
                                          ...
                                          <div class="ms-auto text-secondary">
                                                ...
                                                <div class="ms-2 d-inline-block">
                                                      ...
                                                      <form action="/all-vendors" method="GET" role="search">
                                                            {{ csrf_field() }}
                                    ...
                                    <div class="col-md-4 col-lg-4">
                                          <div class="card">
                                                ...
                                                <div class="d-flex">
                                                      ...
                                                      @php
                                                      $product = 0;
                                                      $product+= App\Models\FcmgProduct::where('seller_id',
                                                      $details->id)->count();
                                                      @endphp
                                                      <a href="fmcg-store/{{$details->id}}" class="card-btn">
